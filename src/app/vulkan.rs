...
impl App {
    ...
    fn create_graphics_pipeline(
        ...
        let binding_descriptions = vertex::Vertex::get_binding_descriptions();
        let attribute_descriptions = vertex::Vertex::get_attribute_descriptions();
